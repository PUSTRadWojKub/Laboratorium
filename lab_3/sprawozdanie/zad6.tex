...
Przetestowaliœmy dzia³anie rozmytego regulatora PID dla ró¿nych funkcji przynale¿noœci: Gaussa, trójk¹tnych  oraz trapezoidalnych. Ponadto dla ka¿dej z tych grup funkcji przeprowadziliœmy eksperymenty dla ró¿nej liczby regulatorów lokalnych $n_\mathrm{r}={2,3,4}$. Lokalne regulatory PID stroiliœmy metod¹ in¿yniersk¹ poprzez stopniowe dostrajanie odpowiednich cz³onów. Za sygna³ prze³¹czaj¹cy regulatory lokalne przyjêliœmy $u(k-1)$.
