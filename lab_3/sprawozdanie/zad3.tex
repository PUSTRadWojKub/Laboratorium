...
\section{Program}
Aby uruchomiæ program nale¿y zapisaæ odpowiedŸ skokow¹ jako '\verb+odp_skok.mat+' w tym samym folderze co skrypt \verb+zad3.m+. Nastêpnie nale¿y ustawiæ odpowiednie wartoœci dla zmiennych o nazwach \lstinline|piddmc| (0 - pid, 1 - dmc) oraz \lstinline|ograniczenia| (0 - wy³¹czone, 1 - w³¹czone).
