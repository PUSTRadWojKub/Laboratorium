...
Regulator PID stroiliœmy metod¹ in¿yniersk¹. W pierwszej kolejnoœci dobraliœmy wartoœæ wzmocnienia. W kolejnych krokach dostrajaliœmy kolejno cz³ony ca³kuj¹cy i ró¿niczkuj¹cy. Kolejne etapy strojenia regulatora zosta³y zilustrowane na rys.~\ref{syg_we_pid1}~$-$~\ref{syg_wy_pid8}.

Ostatecznie przyjêliœmy nastêpuj¹ce nastawy regulatora PID
\begin {equation}
	K = 0.11, T_\mathrm{i} = 4.6, T_\mathrm{d} = 0.65
\end{equation}
Przebiegi uzyskane dla tych wartoœci przedstawiono na rysunkach \ref{syg_we_pid8} oraz \ref{syg_wy_pid8}. Uzyskana wartoœæ wskaŸnika jakoœci $E=403.7229$.
...
\begin{figure}[tb]
	...
	\caption{Kalibracja regulatora PID (krok 1) - sygna³ wyjœciowy i zadany. $E = 9.1217e+03$. Dobieranie nastaw regulatora PID zaczêliœmy ze wzmocnieniem równym 1 i wy³¹czonym cz³onem ca³kuj¹cym oraz ró¿niczkuj¹cym. W nastêpnym kroku zmniejszymy wzmocnienie tak, a¿eby zmniejszyæ oscylacje.}
	\label{syg_wy_pid1}
\end{figure}
...
\begin{figure}[tb]
	...
	\caption{Kalibracja regulatora PID (krok 2) - sygna³ wyjœciowy i zadany. $E = 7.8324e+03$. B³¹d zmala³, obserwujemy uchyb ustalony oraz oscylacje. Aby wyeliminowaæ uchyb zwiêkszamy wp³yw cz³onu ca³kuj¹cego.}
	\label{syg_wy_pid2}
\end{figure}
...
\begin{figure}[tb]
	...
	\caption{Kalibracja regulatora PID (krok 3) - sygna³ wyjœciowy i zadany. $E = 7.3528e+03$.}
	\label{syg_wy_pid3}
\end{figure}
...
\begin{figure}[tb]
	...
	\caption{Kalibracja regulatora PID (krok 4) - sygna³ wyjœciowy i zadany. $E = 6.7934e+03$. Mo¿emy dalej zauwa¿yæ uchyb oraz oscylacje. W celu ich usuniêcia zmniejszamy wzmocnienie oraz zwiêkszamy ca³kowanie.}
	\label{syg_wy_pid4}
\end{figure}
...
\begin{figure}[tb]
	...
	\caption{Kalibracja regulatora PID (krok 5)- sygna³ wyjœciowy i zadany. $E = 414.1249$.}
	\label{syg_wy_pid5}
\end{figure}
...
\begin{figure}[tb]
	...
	\caption{Kalibracja regulatora PID (krok 6) - sygna³ wyjœciowy i zadany. $E = 360.4340$. Widzimy znaczn¹ poprawê zarówno jakoœciow¹ jak i wskaŸnika iloœciowego. W³¹czamy cz³on ró¿niczkuj¹cy w celu skrócenia czasu osi¹gania wartoœci zadanej.}
	\label{syg_wy_pid6}
\end{figure}
...
\begin{figure}[tb]
	...
	\caption{Kalibracja regulatora PID (krok 7) - sygna³ wyjœciowy i zadany. $E = 306.9011$. Mo¿emy zauwa¿yæ poprawê wskaŸnika iloœciowego jednak¿e niepoj¹ce s¹ oscylacje. W celu zniwelowania ich zmniejszymy wzmocnienie, zwiêkszymy ró¿niczkê.}
	\label{syg_wy_pid7}
\end{figure}
...
\begin{figure}[tb]
	...
	\caption{Ostateczny regulator PID - sygna³ wyjœciowy i zadany. $E = 403.7229$. WskaŸnik iloœciowy uleg³ pogorszeniu jednak¿e widzimy poprawê jakoœciow¹ - wyeliminowanie oscylacji.}
	\label{syg_wy_pid8}
\end{figure}
