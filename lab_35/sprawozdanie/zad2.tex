...
W celu uzyskania odpowiedzi skokowych zosta³y przeprowadzone symulacje dla ró¿nych skoków wartoœci sterowania $G1$ i $G2$ z punktu pracy. Wymaga³o to doprowadzenia obiektu do punktu pracy po czym zmiany wartoœci jedego z wejœæ.
...
Poni¿ej zosta³y przedstawione wykresy odpowiedzi skokowych dla ró¿nych zmian, wartoœci sterowania $G1$ i $G2$.
...
Po wyznaczeniu charakterystyki statycznej obiektu mo¿emy zauwa¿yæ ¿e w³aœciwoœci s¹ w przybli¿eniu liniowe dla wartoœci sterowania w przedzia³ach $G1 \in <0, 35>$, $G2 \in <0, 50>$. Równie¿ mo¿emy zauwa¿yæ symetriê wykresów charakterystyk dla $T1$ i $T2$.
